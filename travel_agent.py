...
if gemini_api_key and serp_api_key:
    researcher = Agent(
        ...
        instructions=[
            "Given a travel destination and the number of days the user wants to travel for, first generate a list of 3 searcgemini-2.5-flashh terms related to that destination and the number of days.",
